...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCidPage(@PathVariable("categoryId")Long cid,PageParamVo paramVo){
        PageResultVo resultVo = this.spuService.querySpuByCidPage(cid,paramVo);
